...
$consultascore = $sql -> select ( "SELECT score3 FROM cadastro where login = '$login'");
$consultascore1 = substr(json_encode($consultascore), 12,-3);

echo $consultascore1;

$consultascore2 = $sql -> select ( "SELECT score3 FROM cadastro where login = '$login'");
...
// Check connection
	...
	$sql = "UPDATE cadastro SET score3=$score1 WHERE login = '$login'";
